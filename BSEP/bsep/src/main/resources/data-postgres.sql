...
insert into users(id, user_email,password,first_name,last_name,phone_number,type_of_user) 
values (nextval('my_seq_users'),'marko.jaksic@gmail.com','$2y$12$yf3vBMwc9kCr6sCJP44lZej.7g8HLugBey85TF18mOBJaU8zsUtke','Marko','Jaksic','065-322-3211',1);
insert into users(id, user_email,password,first_name,last_name,phone_number,type_of_user) 
values (nextval('my_seq_users'),'jana.jaksic@gmail.com','$2y$12$qVE0xdJQmVVN3f6koBeg0OXL.qB3mCIZRxnFC9hQtUo7OAMYfkRAC','Marko','Jaksic','065-322-3211',0);
