...
insert into users(id, user_email,password,salt,first_name,last_name,phone_number,type_of_user, is_confirmed) 
values (nextval('my_seq_users'),'dusan.trkulja999@gmail.com','$2y$12$n5BEot0LGg.hzsfumrtRwOkYuwwDcRk9lgsQw4ghG6XbF2voYC.NO','J68kywreweHiLCAna5S532==','Jana','Jaksic','+31636363634',0, true);
