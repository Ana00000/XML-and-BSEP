...
func (repo *SingleStoryRepository) FindAllStories() []model.Story {
	var stories []model.Story
	repo.Database.Select("*").Find(&stories)
	return stories
}

func (repo *SingleStoryRepository) FindByID(ID uuid.UUID) *model.Story {
	story := &model.Story{}
...
func (repo *SingleStoryRepository) FindAllStoriesForUser(userId uuid.UUID) []model.Story {
	var stories []model.Story
...
func (repo *SingleStoryRepository) FindAllFollowingStories(followings []userModel.ClassicUserFollowings) []model.Story {
	var allStories = repo.FindAllStories()
	var allFollowingStories []model.Story
...
func (repo *SingleStoryRepository) FindAllPublicStoriesNotRegisteredUser(allValidUsers []userModel.ClassicUser) []model.Story {
	var allStories = repo.FindAllStories()
	var allPublicStories []model.Story
