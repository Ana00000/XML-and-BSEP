...
export default {
  ...
  methods: {
    init() {
      ...
      this.$http
        .get(
          "https://localhost:8080/api/user/auth/check-find-all-locations-for-public-and-following-posts-permission/",{
            headers: {
              Authorization: "Bearer " + this.token,
            },
          }
    ...
    redirectToSelectedLocation() {
      ...
      window.location.href =
        "https://localhost:8081/postsForSelectedLocationRegistered";
    },
  },
};
</script>
